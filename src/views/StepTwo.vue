...
import { moodleMap, weekSet } from '@/changingValues.ts';
...
export default {
  setup() {
    ...
    const weekOfYear = ref((currentWeek > 0) ? currentWeek : currentWeek + 52);
    ...
    <div class="step-content">
      <form @submit.prevent="generatePdf">
        <ul>
          ...
          <li>
            ...
            <input type="file" id="pdfFile" accept=".pdf,application/pdf" @change="handlePdfFileUpload" required />
          </li>
          <li>
      ...
      <div v-show="!signatureImageAsDataUrl">
        <form @submit.prevent="">
          ...
          <input type="file" id="signature" accept=".jpg,.jpeg,.png,image/jpeg,image/png"
            @change="handleImageFileUpload" />
        </form>
        <p>Ou dessinez la dans le rectangle ci-dessous :</p>
        <div>
          <canvas ref="drawingCanvas" id="drawingCanvas" width="340" height="180" style="border: 1px solid #000;"
